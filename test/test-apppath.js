...
//         helpers.assertFiles([
//           [path.join('customAppPath/scripts', targetDirectory, name + '.js'), new RegExp(generatorType + '\\(\'' + scriptNameFn(name) + suffix + '\'', 'g')],
...
//         angularView.run([], function () {
//           helpers.assertFile(
//               ['customAppPath/views/foo/bar.html']
//           );
//           done();
//         });
//       });
